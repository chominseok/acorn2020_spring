...
<div class="container">
	<a class="btn btn-outline-primary" href="${pageContext.request.contextPath }/cafe/list.do">리스트로 돌아rk기</a>
	<h1>새글 작성 양식 입니다.</h1>
	<form action="insert.do" method="post">
		<div class="form-group">
			<label for="writer">작성자</label>
			<input class="form-contorl" type="text" value="${id}" disabled/>
		</div>
		<div class="form-group">
			<label for="title">제목</label>
			<input class="form-contorl" type="text" name="title" id="title"/>
		</div>
		<div class="form-group">
